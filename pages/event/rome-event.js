            ...
            <FormProvider {...methods}>
                ...
                >
                    ...
                    {languages.locales && languages.locales.map((it, index) => {
                        ...
                        languagesSupported['it-IT'] = ['ga-IE', 'lt-LT', 'pl-PL', 'sk-SK', 'tr-TR'];
                        languagesSupported['pl-PL'] = ['it-IT'];
                        languagesSupported['ga-IE'] = ['en-GB','it-IT'];
                        languagesSupported['lt-LT'] = ['it-IT'];
                        languagesSupported['en-GB'] = ['ga-IE'];
                        languagesSupported['ru-RU'] = ['it-IT'];
            ...
            <main>
                    ...
                    <div className="row pt-4">
                        ...
                        <div className={`col-10 col-lg-4 pt-5 ${styles.purplebackground}`}>
                            <p className={styles.eventheader}>
                                <a name="warsaw">Subtitle-a-thon Challenge Rome</a>
                            </p>
                            ...
                            <p className={styles.whitetext}>
                                Subtitle-a-thon running time: October 23 - October 29, 2021.<br/>
                                Opening session: Saturday, October 23 from 11:00 a.m. to 12:30 p.m.<br/>
                                Closing session: Friday, October 29 at 5:00 p.m.<br/>
                            </p>
                            <br/>
                            ...
                            <p className={styles.whitetext}>
                                October 13 - October 21: Registration open, (participation will be confirmed within few days)
                            </p>
                            <p className={styles.whitetext}>
                ...
                <section className="container-fluid">
                    ...
                    <div className="row pt-4">
                        ...
                        <div className="col-10">
                        <p>
                            We have compiled a selection of TV clips from various European audiovisual heritage institutions for you. Most of the videos are from the collection of Luce Cinecittà. In addition, you will find clips also from FINA (the Polish National Audiovisual and Film archive), RTÉ (the Irish national broadcaster) and LCVA (the Lithuanian State Archive). From newsreels, TV programmes and cartoons, it's all here! We hope you enjoy exploring the 20th century in Europe through these mediatic finds.
                        </p>
                        <p>
                            Abbiamo raccolto per voi una selezione di clip di varie istituzioni audiovisive europee. La maggior parte dei video proviene dalla collezione di Luce Cinecittà. Troverai inoltre clip da FINA (l'archivio audiovisivo e filmico nazionale polacco), RTÉ (l'emittente nazionale irlandese) e LCVA (l'archivio di stato lituano). Cinegiornali, programmi TV e cartoni animati, è tutto qui! Ci auguriamo che vi divertiate ad esplorare il XX secolo in Europa attraverso questi veri e propri reperti mediatici.
                        </p>
                        </div>
                        <div className="col-1"></div>
                    </div>
