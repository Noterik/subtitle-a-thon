        ...
        async function fetchData() {
            ...
            .then(response => {
                if (response.error) {
                    ...
                    //we allow multiple translations in the same language
                    setReserved([]);
                    setLoaded(true);
                } 
            })
...
const Education1Event = () => {
    ...
    return (
        <div className='main-container'>
            <Head>
                <title>Subtitle-a-thon | Education Subtitle-a-thon</title>
            ...
            <main>
                    ...
                    <div className="row pt-4">
                        ...
                        <div className={`col-10 col-lg-4 pt-5 ${styles.purplebackground}`}>
                            <p className={styles.eventheader}>
                                <a name="warsaw">Subtitle-a-thon Challenge Education</a>
                            </p>
                            <p className={styles.whitetext}>
                                Join the Europeana XX: Subtitle-a-thon! Try your hand at subtitling Europe’s audiovisual heritage.
                            </p>
                            <p>&nbsp;</p>
                            <p>&nbsp;</p>
                        </div>
                ...
                <section className="container-fluid">
                    ...
                    <div className="row pt-4">
                        ...
                        <div className="col-10">
                        <p>
                        We have compiled a selection of TV clips from various European audiovisual heritage institutions for you.
                        </p>
                        </div>
                        <div className="col-1"></div>
                    </div>
...
export default Education1Event