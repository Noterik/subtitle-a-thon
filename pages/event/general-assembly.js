...
const GeneralAssembly = () => {
    ...
    return (
        <div className='main-container'>
            ...
            <h1 className={styles.header}>General Assembly subtitle-a-thon</h1>
            ...
            <div className="row w-100 pt-4">
                <div className={`col-6 ${styles.purplebackground}`}>
                    <h2 className={styles.eventheader}>
                        General Assembly Subtitle-a-thon
                    </h2>
                    ...
                    <p className="d-flex justify-content-end pt-4">
                        <div className={styles.button} onClick={() => join(2)}>
                            Join event
                        </div>
                    </p>
                </div>
            ...
            <h2 className={styles.blackSubHeader}>General Assembly videos</h2>
            {
                (() => {
